    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-500 mt-1">Manage animal breeding information</p>
        </div>
            ...
            <TableBody>
              {breedingRecords.map((record: any) => (
                <TableRow key={record.id}>
                  ...
                  <TableCell>{record.breedingMethod.replace("_", " ")}</TableCell>
                  <TableCell>{record.expectedDelivery ? formatDate(record.expectedDelivery) : "N/A"}</TableCell>
